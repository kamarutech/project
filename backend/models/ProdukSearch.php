...
class ProdukSearch extends Produk
{
    ...
    public function rules()
    {
        return [
            [['ID'], 'integer'],
            [['fotoproduk', 'path', 'jenisproduk', 'namaproduk', 'hargaproduk'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'fotoproduk', $this->fotoproduk])
            ->andFilterWhere(['like', 'path', $this->path])
            ->andFilterWhere(['like', 'jenisproduk', $this->jenisproduk])
            ->andFilterWhere(['like', 'namaproduk', $this->namaproduk])
            ->andFilterWhere(['like', 'hargaproduk', $this->hargaproduk]);
